  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div className="card-style w-[400px]">
        ...
        <button disabled className="w-full py-3 bg-bg-main text-white border border-gray-800 rounded-lg flex items-center justify-center gap-2 opacity-50 cursor-not-allowed">
